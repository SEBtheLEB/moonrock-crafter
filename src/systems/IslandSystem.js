import { animals as animalData } from '../data/animals.js?v=44';
import { islands } from '../data/islands.js?v=44';
import { islandResourceNodes } from '../data/islandResources.js?v=44';
