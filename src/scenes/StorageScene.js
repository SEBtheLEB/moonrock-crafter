...
export class StorageScene {
  ...
  formatZone(zoneId) {
    const names = {
      originBlue: 'Inner Circle',
      cobaltRim: 'Inner Mid Circle',
      emberShelf: 'Mid Circle',
      violetReef: 'Outer Mid Circle',
      starlessDeep: 'Outer Circle',
      scrapBelt: 'Inner Circle',
      emberDrift: 'Inner Mid Circle',
      frostRing: 'Mid Circle',
      voidReef: 'Outer Mid Circle',
      starGraveyard: 'Outer Circle',
