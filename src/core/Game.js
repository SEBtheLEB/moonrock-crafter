...
import { InputManager } from './InputManager.js?v=158';
import { SaveManager } from './SaveManager.js';
import { AudioManager } from './AudioManager.js?v=158';
import { UIManager } from '../ui/UIManager.js?v=158';
import { DebugPanel } from '../ui/DebugPanel.js?v=158';
import { InventorySystem } from '../systems/InventorySystem.js';
import { MaterialSystem } from '../systems/MaterialSystem.js';
import { DialogueSystem } from '../systems/DialogueSystem.js?v=158';
import { UpgradeSystem } from '../systems/UpgradeSystem.js?v=158';
import { EconomySystem } from '../systems/EconomySystem.js?v=158';
import { ResearchSystem } from '../systems/ResearchSystem.js?v=158';
import { TutorialSystem } from '../systems/TutorialSystem.js?v=158';
import { QuestSystem } from '../systems/QuestSystem.js?v=158';
import { ObjectiveSystem } from '../systems/ObjectiveSystem.js?v=158';
import { AchievementSystem } from '../systems/AchievementSystem.js?v=158';
import { NavigationSystem } from '../systems/NavigationSystem.js?v=158';
import { IslandSystem } from '../systems/IslandSystem.js?v=158';
import { BuildingSystem } from '../systems/BuildingSystem.js?v=158';
import { BootScene } from '../scenes/BootScene.js';
import { StationScene } from '../scenes/StationScene.js?v=158';
import { MiningScene } from '../scenes/MiningScene.js?v=158';
import { UpgradeScene } from '../scenes/UpgradeScene.js?v=158';
import { StorageScene } from '../scenes/StorageScene.js?v=158';
import { IslandScene } from '../scenes/IslandScene.js?v=158';
import { gameBalance } from '../data/gameBalance.js?v=158';
import { DEFAULT_HOTBAR_SLOT_IDS } from '../data/hotbar.js?v=158';
...
export class Game {
  ...
  mergeState(defaultState, savedState) {
    ...
    if (!savedState.progression?.starterPlatformMigrated) {
      merged.inventory.platformPlacerPp5 = Math.max(
        merged.inventory.platformPlacerPp5 || 0,
        gameBalance.startingInventory.platformPlacerPp5 || 1,
      );
      merged.inventory.thinPlatform = Math.max(
        merged.inventory.thinPlatform || 0,
        gameBalance.startingInventory.thinPlatform || 120,
      );
      if (!merged.hotbar.includes('pp5')) {
        const emptyIndex = merged.hotbar.findIndex((slot) => !slot);
        if (emptyIndex >= 0) merged.hotbar[emptyIndex] = 'pp5';
        else merged.hotbar[merged.hotbar.length - 1] = 'pp5';
      }
      merged.progression ||= {};
