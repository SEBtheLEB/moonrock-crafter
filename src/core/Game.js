...
import { AudioManager } from './AudioManager.js?v=31';
import { UIManager } from '../ui/UIManager.js';
import { DebugPanel } from '../ui/DebugPanel.js?v=31';
import { InventorySystem } from '../systems/InventorySystem.js';
import { MaterialSystem } from '../systems/MaterialSystem.js';
import { DialogueSystem } from '../systems/DialogueSystem.js?v=31';
import { UpgradeSystem } from '../systems/UpgradeSystem.js?v=31';
import { EconomySystem } from '../systems/EconomySystem.js?v=31';
import { ResearchSystem } from '../systems/ResearchSystem.js?v=31';
import { TutorialSystem } from '../systems/TutorialSystem.js?v=31';
import { ObjectiveSystem } from '../systems/ObjectiveSystem.js?v=31';
import { AchievementSystem } from '../systems/AchievementSystem.js?v=31';
import { NavigationSystem } from '../systems/NavigationSystem.js?v=31';
import { IslandSystem } from '../systems/IslandSystem.js?v=31';
import { BootScene } from '../scenes/BootScene.js';
import { StationScene } from '../scenes/StationScene.js?v=31';
import { MiningScene } from '../scenes/MiningScene.js?v=31';
import { UpgradeScene } from '../scenes/UpgradeScene.js?v=31';
import { StorageScene } from '../scenes/StorageScene.js?v=31';
import { IslandScene } from '../scenes/IslandScene.js?v=31';
