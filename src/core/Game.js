...
import { InputManager } from './InputManager.js?v=157';
import { SaveManager } from './SaveManager.js';
import { AudioManager } from './AudioManager.js?v=157';
import { UIManager } from '../ui/UIManager.js?v=157';
import { DebugPanel } from '../ui/DebugPanel.js?v=157';
import { InventorySystem } from '../systems/InventorySystem.js';
import { MaterialSystem } from '../systems/MaterialSystem.js';
import { DialogueSystem } from '../systems/DialogueSystem.js?v=157';
import { UpgradeSystem } from '../systems/UpgradeSystem.js?v=157';
import { EconomySystem } from '../systems/EconomySystem.js?v=157';
import { ResearchSystem } from '../systems/ResearchSystem.js?v=157';
import { TutorialSystem } from '../systems/TutorialSystem.js?v=157';
import { QuestSystem } from '../systems/QuestSystem.js?v=157';
import { ObjectiveSystem } from '../systems/ObjectiveSystem.js?v=157';
import { AchievementSystem } from '../systems/AchievementSystem.js?v=157';
import { NavigationSystem } from '../systems/NavigationSystem.js?v=157';
import { IslandSystem } from '../systems/IslandSystem.js?v=157';
import { BuildingSystem } from '../systems/BuildingSystem.js?v=157';
import { BootScene } from '../scenes/BootScene.js';
import { StationScene } from '../scenes/StationScene.js?v=157';
import { MiningScene } from '../scenes/MiningScene.js?v=157';
import { UpgradeScene } from '../scenes/UpgradeScene.js?v=157';
import { StorageScene } from '../scenes/StorageScene.js?v=157';
import { IslandScene } from '../scenes/IslandScene.js?v=157';
import { gameBalance } from '../data/gameBalance.js?v=157';
import { DEFAULT_HOTBAR_SLOT_IDS } from '../data/hotbar.js?v=157';
